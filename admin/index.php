            ...
            <div class="main">
                <header class="header">
                    ...
                    <form method="GET" class="search">
                        <input type="search" name="search" class="search__input" placeholder="Search User">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="delete.php?id=<?= $user["id"]?>" class="delete" title="Delete" data-toggle="tooltip"><i class="fa <?php echo $ban ? "fa-unlock":"fa-lock" ?>" aria-hidden="true"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
